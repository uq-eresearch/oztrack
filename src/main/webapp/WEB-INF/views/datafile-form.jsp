...
2/04/2010,22:17:23,-17.559016,146.087858
        ...
        <ul>
            ...
            <li><tt>DOP</tt>: Dilution of Precision (DOP) value as decimal number (optional)</li>
            <li><tt>SST</tt>: Sea Surface Temperature (SST) value in °C as decimal number (optional)</li>
        </ul>
