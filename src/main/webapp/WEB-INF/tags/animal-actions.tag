...
<div class="sidebar-actions">
    ...
    <ul class="icons sidebar-actions-list">
        ...
        <li class="delete-animal"><a href="javascript:void(deleteEntity('${pageContext.request.contextPath}/animals/${animal.id}', '${pageContext.request.contextPath}/projects/${animal.project.id}/animals', 'Are you sure you want to delete this animal?'));">Delete animal</a></li>
        </c:if>
    </ul>
</div>
</sec:authorize>