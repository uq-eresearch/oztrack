...
public interface PositionFixDao {
    ...
    int setDeletedOnOverlappingPositionFixes(Project project, MultiPolygon multiPolygon, boolean deleted);
    int setDeletedOnAllPositionFixes(Project project, boolean deleted);
}