    ...
    <description>
      <![CDATA[
        ...
        <table style="float: left; margin-right: 20px; border-collapse: collapse;">
          <tr>
            <th style="border: 2px ridge; min-width: 100px; padding: 2px 4px; text-align: left; background-color: #ddd;">Parameter</th>
            <th style="border: 2px ridge; min-width: 100px; padding: 2px 4px; text-align: left; background-color: #ddd;">Value</th>
          </tr>
          <#list analysis.analysisType.parameterTypes as parameterType>
          <tr>
        ...
        <table style="float: left; border-collapse: collapse;">
          <tr>
            <th style="border: 2px ridge; min-width: 100px; padding: 2px 4px; text-align: left; background-color: #ddd;">Attribute</th>
            <th style="border: 2px ridge; min-width: 100px; padding: 2px 4px; text-align: left; background-color: #ddd;">Value</th>
          </tr>
          <#list analysis.analysisType.overallResultAttributeTypes as resultAttributeType>
          <tr>
