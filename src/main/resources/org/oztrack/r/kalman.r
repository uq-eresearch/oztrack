...
fkalmankmlHeader <- function(fit) { 
  ...
  headers <- append(headers, "<SimpleData name=\"sxValue\">" %+% fit$estimates[6] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"sxStdDev\">" %+% fit$std.dev[6] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"syValue\">" %+% fit$estimates[7] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"syStdDev\">" %+% fit$std.dev[7] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"a0Value\">" %+% fit$estimates[8] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"a0StdDev\">" %+% fit$std.dev[8] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"b0Value\">" %+% fit$estimates[9] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"b0StdDev\">" %+% fit$std.dev[9] %+% "</SimpleData>")
