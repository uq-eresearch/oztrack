...
fkfsstkmlHeader <- function(fit) { 
  ...
  headers <- append(headers, "<SimpleData name=\"Negativeloglik\">" %+% fit$nlogL %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"MaxGradComp\">" %+% fit$max.grad.comp %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"uValue\">" %+% fit$estimates[1] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"uStdDev\">" %+% fit$std.dev[1] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"vValue\">" %+% fit$estimates[2] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"vStdDev\">" %+% fit$std.dev[2] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"DValue\">" %+% fit$estimates[3] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"DStdDev\">" %+% fit$std.dev[3] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"bxValue\">" %+% fit$estimates[4] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"bxStdDev\">" %+% fit$std.dev[4] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"byValue\">" %+% fit$estimates[5] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"byStdDev\">" %+% fit$std.dev[5] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"bsstValue\">" %+% fit$estimates[6] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"bsstStdDev\">" %+% fit$std.dev[6] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"sxValue\">" %+% fit$estimates[7] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"sxStdDev\">" %+% fit$std.dev[7] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"syValue\">" %+% fit$estimates[8] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"syStdDev\">" %+% fit$std.dev[8] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"ssstValue\">" %+% fit$estimates[9] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"ssstStdDev\">" %+% fit$std.dev[9] %+% "</SimpleData>")  
  headers <- append(headers, "<SimpleData name=\"radiusValue\">" %+% fit$estimates[10] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"radiusStdDev\">" %+% fit$std.dev[10] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"a0Value\">" %+% fit$estimates[11] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"a0StdDev\">" %+% fit$std.dev[11] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"b0Value\">" %+% fit$estimates[12] %+% "</SimpleData>")
  headers <- append(headers, "<SimpleData name=\"b0StdDev\">" %+% fit$std.dev[12] %+% "</SimpleData>")
